...
public interface ICashFlowRepository
{
    ...
    Task<(List<CashFlowDailyAggregate?> response, long totalItemCount, int totalPages)> GetByAccountIdAndDateRange(Guid accountId, DateOnly startDate, DateOnly endDate, int pageNumber = 1, int pageSize= 50);
